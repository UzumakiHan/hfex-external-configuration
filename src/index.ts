export default [
    {
        version: ['3.5.1', '2.8.1', '4.1.3', '3.6.5'],
        name: 'vue-router',
        type: 'npm',
        packageInfo: [
            {
            ...
            },
            {
                version: '4.1.3',
                packageLink:
                    'https://unpkg.com/vue-router@4.1.3/dist/vue-router.global.prod.js',
                exposedField: 'VueRouter',
            },
            {
                version: '3.6.5',
    ...
    {
        version: ['2.6.12', '3.2.31', '2.7.14', '3.3.0'],
        name: 'vue',
        type: 'npm',
        packageInfo: [
            {
            ...
            },
            {
                version: '3.3.0',
                packageLink:
                    'https://unpkg.com/vue@3.3.0/dist/vue.runtime.global.prod.js',
                exposedField: 'Vue',
            },
        ],
        __v: 0,
